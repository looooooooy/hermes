"""Open Host SPI endpoints with one process-scoped Windows authority."""
...
class WindowsHostEndpointOpener:
    """Bind Gateway, Observer, and Control to one immutable Host process identity."""

    def __init__(
        self,
        *,
        backend: LocalRelayBackendPort,
        host_authority_factory: Callable[..., WindowsHostAuthorityV2] = (
            capture_windows_host_authority
        ),
    ) -> None:
        ...
        self._host_authority: WindowsHostAuthorityV2 | None = None
...
__all__ = ["WindowsHostEndpointOpener"]
