"""Ed25519 device identity backed only by macOS secure storage."""
...
class MacOSKeychainDeviceIdentity:
    """Expose public identity/signing while keeping private seed behind a store."""
