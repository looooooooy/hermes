"""Frozen ORM shapes for published Observer subscription migrations."""
...
class ObserverSubscriptionV7Base(DeclarativeBase):
    """Subscription schema exactly as published through SQLite v7."""


class ObserverSubscriptionTargetV7Model(ObserverSubscriptionV7Base):
...
class ObserverSubscriptionLeaseV7Model(ObserverSubscriptionV7Base):
...
class ObserverSubscriptionIntentV7Model(ObserverSubscriptionV7Base):
...
class ObserverConnectorRouteV7Model(ObserverSubscriptionV7Base):
